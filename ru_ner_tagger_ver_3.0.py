...
class Tagger:
    ...
    def SaveFile(self):
        ...
        tagged_data = pd.DataFrame({"Sentences":self.sentences, "Tagged":self.tagged_sentences  ,"PER_COUNT":self.per_count, "ORG_COUNT":self.org_count, "LOC_COUNT":self.loc_count})
        try:
